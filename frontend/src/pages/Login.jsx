      ...
      <div className="w-full max-w-md">
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          ...
          <div className="flex items-center my-6">
            ...
            <span className="px-4 text-gray-500 text-sm">o continua con</span>
            <div className="flex-1 border-t border-gray-700"></div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <a
              ...
              className="flex items-center justify-center gap-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 text-white py-3 rounded-lg font-medium transition-colors"
            >
